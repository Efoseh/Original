<HTML>
  <HEAD>
    ...
    <meta name="google-site-verification" content="x0V1beM5uYNhqQMoTBxFmfJm48iUFBmnudb_pMDO2Pc">
  </HEAD>
<BODY>
<?php
/**
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-145188789-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-145188789-1');
</script>
