...
> Please note that this plugin requires the [Classic Editor](https://wordpress.org/plugins/classic-editor/) for WordPress version 5 and higher. If you are using [Gutenberg](https://es.wordpress.org/plugins/gutenberg/) you can use it in the ["Classic" Block](https://wordpress.org/gutenberg/handbook/contributors/faq/#will-i-be-able-to-opt-out-of-gutenberg-for-my-site).
